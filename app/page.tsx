  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        {error && (
          <div className="container py-6">
            <div className="flex items-start gap-3 rounded-2xl border border-destructive/30 bg-destructive/5 p-4">
              ...
              <div>
                <p className={`text-sm font-semibold text-destructive ${isHindi ? "font-devanagari" : ""}`}>
                  {isHindi ? "पूर्वानुमान त्रुटि" : "Forecast Error"}
                </p>
        ...
        <InsightsSection insights={forecastData?.insights} />
        <FaqSection />
      </main>
